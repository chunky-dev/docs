...
- <samp>Sky Mode</samp>: Dropdown menu to select the simulation model for the sky.
	...
	- <samp>Preetham</samp>: A faster simulation of daytime skies. It is more similar to the Minecraft sky. An example panorama of the Preetham sky is displayed in [Figure 3](#figure-3).

	- <samp>Nishita</samp>: A slower and more realistic sky simulation that can also simulate twilight. An example panorama of the Nishita sky is displayed in [Figure 3](#figure-3).
...
{% if extra.chunky < 2_05_00 %}### Skymap (panoramic){% endif %}{% if extra.chunky >= 2_05_00 %}### Skymap (equirectangular){% endif %}
...
{% if extra.chunky < 2_05_00 %}### Skymap (spherical){% endif %}{% if extra.chunky >= 2_05_00 %}### Skymap (angular){% endif %}
...
- <samp>Skybox pitch</samp>: Changes the pitch of the Skybox.

- <samp>Skybox yaw</samp>: Changes the yaw of the Skybox.

- <samp>Skybox roll</samp>: Changes the roll of the Skybox.

{% endif %}

<div class="figure" id="figure-3">
  <p class="figure">Figure 3: Preetham sky and Nishita sky panoramas</p>
  <div class="figureimgcontainer">
