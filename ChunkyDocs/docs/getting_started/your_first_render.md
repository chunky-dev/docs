...
<div class="figure" id="figure-1">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/mc_f3_menu.jpg">
      <img class="figure" src="../../img/getting_started/your_first_render/mc_f3_menu.jpg" alt="Minecraft Debug Screen">
    </a>
  </div>
</div>
...
<div class="figure" id="figure-2">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/user_interface/chunky/stable/overview_no_map.png">
      <img class="figure" src="../../img/user_interface/chunky/stable/overview_no_map.png" alt="Chunky with no world loaded">
    </a>
  </div>
</div>

Currently, no world is loaded into Chunky. Click on `Change World`, located in the [`Map View`](../../reference/user_interface/chunky/stable/right_panel_controls/map_view) tab in the right panel to select a world to load. You should be presented with a window like the one shown in [Figure 3](#figure-3).
...
<div class="figure" id="figure-3">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/user_interface/chunky/stable/right_panel/select_world.png">
      <img class="figure" src="../../img/user_interface/chunky/stable/right_panel/select_world.png" alt="World selection dialog box">
    </a>
  </div>
</div>

Once you have located the world, click on `Load selected world`. The [`Map`](../../reference/user_interface/chunky/stable/map) tab will load an interactive map view of your world, as shown in [Figure 4](#figure-4).
...
<div class="figure" id="figure-4">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/user_interface/chunky/stable/overview.png">
      <img class="figure" src="../../img/user_interface/chunky/stable/overview.png" alt="Map view of the loaded world">
    </a>
  </div>
</div>
...
To load chunks, either right click on the map view located in the center panel and click on `New scene from selection`, or click on `Load selected chunks`, which is found in the [`Scene`](../../reference/user_interface/chunky/stable/render_controls/scene) tab in the left panel, which contains render controls. After loading the selected chunks, the center panel should automatically switch to the [`Render Preview`](../../reference/user_interface/chunky/stable/render_preview) tab, which displays a 3D preview of the chunks selected from your world. The progress bar at the bottom should be filled. The time it takes to load the selected chunks increases with the number of chunks selected.
...
<div class="figure" id="figure-5">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/scene.png">
      <img class="figure" src="../../img/getting_started/your_first_render/scene.png" alt="Render preview">
    </a>
  </div>
</div>
...
Next, open the [`Camera`](../../reference/user_interface/chunky/stable/render_controls/camera) tab.
...
<div class="figure" id="figure-6">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/camera.png">
      <img class="figure" src="../../img/getting_started/your_first_render/camera.png" alt="Camera tab">
    </a>
  </div> 
</div>
...
Enter the X-, Y-, and Z-coordinates for the camera into the three input fields on the `Position` row, pressing the Enter key after each one. Do the same with the Camera pitch and yaw values, but place them into the first two input fields of the `Orientation` row, pressing the Enter key after each one. If `Load entities > Players` in the `Scene` tab was enabled when you clicked `Load selected chunks`, then the camera may clip into the player after you enter the values, as shown in [Figure 7](#figure-7).
...
<div class="figure" id="figure-7">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/camera_ps_imported_player.png">
      <img class="figure" src="../../img/getting_started/your_first_render/camera_ps_imported_player.png"   alt="Camera clipping into player">
    </a>
  </div>
</div>

To remove the player, open the [`Entities`](../../reference/user_interface/chunky/stable/render_controls/entities) tab, select the player which the camera is clipping into (likely the first and only one on the list), and then press the `-` button.
...
<div class="figure" id="figure-8">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/camera_ps_imported.png">
      <img class="figure" src="../../img/getting_started/your_first_render/camera_ps_imported.png" alt="Player removed from the scene">
    </a>
  </div>
</div>
...
Open the [`Lighting`](../../reference/user_interface/chunky/stable/render_controls/lighting) tab.
...
<div class="figure" id="figure-9">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/lighting.png">
      <img class="figure" src="../../img/getting_started/your_first_render/lighting.png" alt="Lighting tab">
    </a>
  </div>
</div>
...
Open the [`Sky & Fog`](../../reference/user_interface/chunky/stable/render_controls/sky_and_fog) tab.
...
<div class="figure" id="figure-10">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/sky_fog.png">
      <img class="figure" src="../../img/getting_started/your_first_render/sky_fog.png" alt="Sky & Fog tab">
    </a>
  </div>
</div>
...
Open the [`Water`](../../reference/user_interface/chunky/stable/render_controls/water) tab.
...
<div class="figure" id="figure-11">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/water.png">
      <img class="figure" src="../../img/getting_started/your_first_render/water.png" alt="Water tab">
    </a>
  </div>
</div>
...
Open the [`Advanced`](../../reference/user_interface/chunky/stable/render_controls/advanced) tab.
...
<div class="figure" id="figure-12">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/advanced.png">
      <img class="figure" src="../../img/getting_started/your_first_render/advanced.png" alt="Advanced tab">
    </a>
  </div>
</div>
...
<div class="figure" id="figure-14">
  ...
  <div class="figureimgcontainer">
    <a href="../../img/getting_started/your_first_render/first_render.png">
      <img class="figure" src="../../img/getting_started/your_first_render/first_render.png" alt="Finished render">
    </a>
  </div>
</div>
