...
<a href="https://github.com/ThatRedox" target="_blank">:material-account: ThatRedox</a> &middot; <a href="https://github.com/ThatRedox/ChunkyAnimation" target="_blank">:material-github: GitHub Repository</a> &middot; <a href="https://nightly.link/ThatRedox/ChunkyAnimation/workflows/master/master/ChunkyAnimatePlugin.zip" target="_blank">:material-tag: Latest build from master</a>
...
The current release of the plugin functions normally when used with the [Stable](../../getting_started/configuring_chunky_launcher#advanced-settings) release or the [Stable snapshot](../../getting_started/configuring_chunky_launcher#advanced-settings) release of Chunky; however, there are glitches that occur when it is used with the [Snapshot](../../getting_started/configuring_chunky_launcher#advanced-settings) release of Chunky.
...
The 0.2.1 release of the plugin requires the [Stable](../../getting_started/configuring_chunky_launcher#advanced-settings) release or the [Stable snapshot](../../getting_started/configuring_chunky_launcher#advanced-settings) release of Chunky, while the 0.3.0 release of the plugin requires the [Snapshot](../../getting_started/configuring_chunky_launcher#advanced-settings) release of Chunky.
...
!!! info "Renderer switching in Chunky 2.4.0 or later"
    ...
    Plugins which have not yet been updated to support the new `addRenderer` API feature (such as the <a href="https://github.com/llbit/Chunky-AOPlugin" target="_blank">Ambient Occlusion Plugin</a> and <a href="https://github.com/llbit/Chunky-DepthPlugin" target="_blank">Depth Buffer Plugin</a>) are still supported and are added with the name of `PluginRenderer`.
...
- Step 6: Click the `...` button, and then browse for `oidnDenoise.exe`, which is located in the `bin` folder of the extracted OIDN ZIP file.
