This is a list of known plugins. If some plugin is missing, feel free to add it to this page and submit a PR.
...
A WIP OpenCL raytracer for Chunky. Requires Chunky 2.4.0 or later.
